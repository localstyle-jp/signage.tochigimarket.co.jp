        ...
        <tr
          ...
          <td>
            <div class="btn_area" style="text-align:left;">
              ...
              <a href="<?= $this->Url->build(['controller' => 'machine-boxes', 'action' => 'index', '?' => ['sch_content' => $data->id]]); ?>"
                class="btn btn-primary btn-sm"><i class="fas fa-desktop"></i> 端末一覧</a>
              <a href="/content/<?= $data->id; ?>"
                class="btn btn-info btn-sm" target="_blank"><i class="fas fa-search"></i> プレビュー</a>
            </div>
          </td>

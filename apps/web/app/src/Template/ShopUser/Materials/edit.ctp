          ...
          <div class="card-body">
            ...
            <div class="table_edit_area">
              <div class="form-group row">
                <label for="" class="col-12 col-md-3 col-form-label control_title">素材名<span
              ...
              <div class="form-group row">
                <label for="" class="col-12 col-md-3 col-form-label control_title">タイプ<span
                    class="attent">※必須</span></label>
                <div class="col-12 col-md-9 control_value">
              ...
              <div class="form-group row changeArea imageArea contentArea">
                ...
                <div class="col-12 col-md-9 control_value">
                  ...
                  <div>
                    ...
                    <br><span class="changeArea imageArea">推奨サイズ 1920 x 1080</span><span
                      class="changeArea contentArea">推奨サイズ 960 x 540</span>
                  </div>
                  <?php endif;?>
                </div>
              </div>
              ...
              <div class="form-group row changeArea soundArea">
                <?php $_column = 'file'; ?>
                <label for="" class="col-12 col-md-3 col-form-label control_title">音楽<span
                    class="attent">※必須</span></label>
                <div class="col-12 col-md-9 control_value">
                  <ul>
              ...
              <div class="form-group row changeArea movieArea">
                <?php $_column = 'file'; ?>
                <label for="" class="col-12 col-md-3 col-form-label control_title">動画<span
                    class="attent">※必須</span></label>
                <div class="col-12 col-md-9 control_value">
              ...
              <div class="form-group row changeArea mp4Area webmArea">
                <?php $_column = 'file'; ?>
                <label for="" class="col-12 col-md-3 col-form-label control_title">ファイル<span
                    class="attent">※必須</span></label>
                <div class="col-12 col-md-9 control_value">
                  <ul>
                    <?php if (!empty($entity['attaches'][$_column]['0'])) :?>
              ...
              <div class="form-group row changeArea contentArea">
                <?php $_column = 'file'; ?>
                <label for="" class="col-12 col-md-3 col-form-label control_title">コンテンツ<span
                    class="attent">※必須</span></label>
                <div class="col-12 col-md-9 control_value">
...
<script>
  ...
  $(function() {
    ...
    document.getElementById(
        'mate_mp4_<?= $entity['id'] ?>').currentTime =
      1.0;

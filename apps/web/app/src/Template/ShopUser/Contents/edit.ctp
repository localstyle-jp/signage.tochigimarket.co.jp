    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?= $this->Url->build(['action' => 'index']); ?>">コンテンツ</a></li>
          ...
          <div class="card-body">
            ...
            <div class="table_edit_area">
              ...
              <div class="form-group row">
                <label for="" class="col-12 col-md-3 col-form-label control_title">コンテンツ名<span class="attent">※必須</span></label>

    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><span>コンテンツ</span></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class=" card-body">
            <div class="btn_area center">
              <a href="<?= $this->Url->build(array('action' => 'edit', '?' => $query)); ?>" class="btn btn_post w-20 rounded-pill"><i class="far fa-plus-square"></i> 新規登録</a>
            </div>
            
            <div style="" class="mb-2 mt-2 text-center"><?= $this->element('pagination');?></div>

            <?= $this->element('index_list-contents', ['count' => $count]); ?>

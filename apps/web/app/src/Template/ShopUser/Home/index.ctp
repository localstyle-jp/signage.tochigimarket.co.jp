        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a href="<?= $this->Url->build(['_name' => 'shopAdmin']); ?>">Home</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              ...
              <div class="card-body row">
                <div class="col-12 col-md-4 mb-2">
                  <a href="<?= $this->Url->build('/shop_user/materials/'); ?>" class="btn btn-block btn-secondary btn-lg">
                    素材
                  ...
                  <div class="card" style="">
                    <div class="card-header bg-secondary">
                      <!-- <div class="col-12"> -->
                        ...
                        <div class="card-tools">
                          <a href="<?= $this->Url->build(['controller' => 'machine-boxes','action' => 'edit', $data->id]); ?>" type="button" class="btn btn-tool" style="color:#FFF;"><i class="fas fa-cog"></i></a>
                        </div>
                      <!-- </div> -->

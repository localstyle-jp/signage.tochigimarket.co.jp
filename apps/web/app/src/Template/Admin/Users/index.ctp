...
<div class="content_inr">
  ...
  <div class="box">
    ...
    <div class="btn_area" style="margin-top:10px;"><a
        ...
        class="btn_confirm">新規登録</a></div>
    <span
      class="result"><?php echo $count['total']; ?>件の登録</span>
    <div class="table_area">
      <table>
        <tr>
          ...
          <th style="text-align:left; width: 250px;">メールアドレス</th>
...
foreach ($query->toArray() as $key => $data):
    ...
    ?>
        ...
        <tr
          ...
          <td>
            <?= $this->Html->link($data->email, $this->url->build(['action' => 'edit', $data->id])); ?>
          </td>
